...
* 開発者が気持ちよく開発や運用できるための環境作りに注力
  * 輪読会実施 (開発手法の啓蒙)
  * 監視ツール導入 (Datadog、New Relic)
  * Pull Requestレビューフロー改善
  * 障害検知・復旧迅速化の仕組み導入
  * CI/CDパイプライン整備
  * Infrastructure as Code整備
* スキル向上及び課題解決のためにOSS公開に取り組んでいる
  * TypeScriptやGoなど業務では使用しないスキルのキャッチアップを心がけている
  * 開発者が困っている問題を解決するもの作っている

## やりたいこと
* 自身の長所であるフロントエンドのスキルを活かしたプロダクト価値の向上と開発体験を向上させる改善活動で開発者の生産性最大化を実現したい
